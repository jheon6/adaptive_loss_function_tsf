#!/usr/bin/env bash
# ============================================================
# Full ablation study: ETTm1, DLinear, pred_len = 96
# All 5 experiments are saved under a single timestamped folder:
#   result/ablation_ettm1_YYYYMMDD_HHMM/
#     dlinear_ettm1_mse_only/report.html
#     dlinear_ettm1_mse_mae_fixed/report.html
#     dlinear_ettm1_mse_trend_fixed/report.html
#     dlinear_ettm1_mse_mae_trend_fixed/report.html
#     dlinear_ettm1_adaptive/report.html
#
...
RESULT_DIR="result/ablation_ettm1_${TIMESTAMP}"
...
CONFIGS=(
    "mse_only_ettm1"
    "mse_mae_fixed_ettm1"
    "mse_trend_fixed_ettm1"
    "mse_mae_trend_fixed_ettm1"
    "adaptive_ettm1"
)
