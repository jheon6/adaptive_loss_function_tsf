#!/usr/bin/env bash
# ============================================================
# Full ablation study: ETTh2, DLinear, pred_len = 96
# All 5 experiments are saved under a single timestamped folder:
#   result/ablation_etth2_YYYYMMDD_HHMM/
#     dlinear_etth2_mse_only/report.html
#     dlinear_etth2_mse_mae_fixed/report.html
#     dlinear_etth2_mse_trend_fixed/report.html
#     dlinear_etth2_mse_mae_trend_fixed/report.html
...
RESULT_DIR="result/ablation_etth2_${TIMESTAMP}"
