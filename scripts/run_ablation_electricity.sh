#!/usr/bin/env bash
# ============================================================
# Full ablation study: Electricity, DLinear, pred_len = 96
# All 5 experiments are saved under a single timestamped folder:
#   result/ablation_electricity_YYYYMMDD_HHMM/
#     dlinear_electricity_mse_only/report.html
#     dlinear_electricity_mse_mae_fixed/report.html
#     dlinear_electricity_mse_trend_fixed/report.html
#     dlinear_electricity_mse_mae_trend_fixed/report.html
#     dlinear_electricity_adaptive/report.html
#
...
RESULT_DIR="result/ablation_electricity_${TIMESTAMP}"
echo "Ablation output dir: $ROOT/$RESULT_DIR"
echo ""

CONFIGS=(
    "mse_only_electricity"
    "mse_mae_fixed_electricity"
    "mse_trend_fixed_electricity"
    "mse_mae_trend_fixed_electricity"
    "adaptive_electricity"
)
